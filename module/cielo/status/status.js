    ...
    if (status !== 1 && status !== 2) {
        switch (returnCode) {
            ...
            case "14":
                ...
                break;
            case "13":
                message = "Transação não autorizada. Valor inválido. Refazer a transação confirmando os dados informados. Persistindo o erro, entrar em contato com a Dot Pet.";
                break;
            case "19":
            case "25":
            case "72":
            ...
            case "99":
            case "999":
                message = "Não foi possível processar a transação. Refaça a transação ou tente novamente mais tarde. Se o erro persistir entre em contato com a Dot Pet.";
                break;
            case "58":
